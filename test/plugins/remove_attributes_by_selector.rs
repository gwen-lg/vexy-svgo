// this_file: test/plugins/remove_attributes_by_selector.rs

//! Integration tests for the removeAttributesBySelector plugin

use vexy_svgo::ast::Document;
use vexy_svgo::parser::Parser;
use vexy_svgo_plugin_sdk::plugins::RemoveAttributesBySelectorPlugin;
use vexy_svgo::plugin::{Plugin, PluginInfo};
use vexy_svgo::stringifier::stringify;
use serde_json::json;
