...
//! You can contact me at <me+vexy-svgo@gwenlg.fr> or on the repository <https://github.com/gwen-lg/vexy-svgo>.

fn main() {
    println!(
        r"The Vexy-SVGO project is currently unavailable!
        If you're interested in funding a working version, please contact me to discuss options.
        You can contact me at mailto:me+vexy-svgo@gwenlg.fr or on the repository https://github.com/gwen-lg/vexy-svgo."
    );
}
